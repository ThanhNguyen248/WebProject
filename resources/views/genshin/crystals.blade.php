    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card ribbon-box">
                <div class="card-body">
                    <div class="mb-4">
                        <div class="ribbon ribbon-primary ribbon-shape">TẠO ĐƠN HÀNG ĐÁ SÁNG THẾ</div>
                    </div>
                    <form id="form">
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="118" id="pack118" data-product-name="60 Đá Sáng Thế">
                                    <label class="form-check-label" for="pack118">60 Đá Sáng Thế <span class="badge bg-info">23.000đ</span></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="119" id="pack119" data-product-name="300 + 30 Đá Sáng Thế">
                                    <label class="form-check-label" for="pack119">300 + 30 Đá Sáng Thế <span class="badge bg-info">95.000đ</span></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="120" id="pack120" data-product-name="980 + 110 Đá Sáng Thế">
                                    <label class="form-check-label" for="pack120">980 + 110 Đá Sáng Thế <span class="badge bg-info">290.000đ</span></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="121" id="pack121" data-product-name="1980 + 260 Đá Sáng Thế">
                                    <label class="form-check-label" for="pack121">1980 + 260 Đá Sáng Thế <span class="badge bg-info">635.000đ</span></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="122" id="pack122" data-product-name="3280 + 600 Đá Sáng Thế">
                                    <label class="form-check-label" for="pack122">3280 + 600 Đá Sáng Thế <span class="badge bg-info">950.000đ</span></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="123" id="pack123" data-product-name="6480 + 1600 Đá Sáng Thế">
                                    <label class="form-check-label" for="pack123">6480 + 1600 Đá Sáng Thế <span class="badge bg-info">1.950.000đ</span></label>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 row">
...
$(function() {
    ...
    var checked = $('input[name=service_pack]:checked');
    if (checked.length) {
        $('#product_name').val(checked.data('product-name'));
    }

    $('#btnSubmit').on('click', function() {
        console.log('Đã bấm nút tạo đơn'); 
        $.ajax({
            url: "{{ url('/api/orders') }}",
            method: "POST",
            dataType: "JSON",
