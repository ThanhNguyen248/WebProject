    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">FILM TRẮNG ĐEN</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0" style="font-size:13px;">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Trang chủ</a></li>
                        <li class="breadcrumb-item">NẠP ZENLESS ZONE ZERO</li>
                        <li class="breadcrumb-item active">FILM TRẮNG ĐEN</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card ribbon-box">
                <div class="card-body">
                    <div class="mb-4">
                        <div class="ribbon ribbon-primary ribbon-shape">TẠO ĐƠN HÀNG FILM TRẮNG ĐEN</div>
                    </div>
                    <form id="form">
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="118" id="pack118" data-product-name=" 60 Film Trắng Đen">
                                    <label class="form-check-label" for="pack118">60 Film Trắng Đen <span class="badge bg-info">23.000đ</span></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="119" id="pack119" data-product-name=" 300 Film Trắng Đen">
                                    <label class="form-check-label" for="pack119">300 + 30 Film Trắng Đen <span class="badge bg-info">95.000đ</span></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="120" id="pack120" data-product-name=" 980 Film Trắng Đen">
                                    <label class="form-check-label" for="pack120">980 + 110 Film Trắng Đen <span class="badge bg-info">290.000đ</span></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="121" id="pack121" data-product-name=" 1980 Film Trắng Đen">
                                    <label class="form-check-label" for="pack121">1980 + 260 Film Trắng Đen <span class="badge bg-info">635.000đ</span></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="122" id="pack122" data-product-name=" 3280 Film Trắng Đen">
                                    <label class="form-check-label" for="pack122">3280 + 600 Film Trắng Đen <span class="badge bg-info">950.000đ</span></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input pack" name="service_pack" value="123" id="pack123" data-product-name=" 6480 Film Trắng Đen">
                                    <label class="form-check-label" for="pack123">6480 + 1600 Film Trắng Đen <span class="badge bg-info">1.950.000đ</span></label>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 row">
