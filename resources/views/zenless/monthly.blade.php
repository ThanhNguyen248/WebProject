    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">THẺ THÁNG ZENLESS ZONE ZERO</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0" style="font-size:13px;">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Trang chủ</a></li>
                        <li class="breadcrumb-item">NẠP ZENLESS ZONE ZERO</li>
                        <li class="breadcrumb-item active">THẺ THÁNG ZENLESS ZONE ZERO</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card ribbon-box">
                <div class="card-body">
                    <div class="mb-4">
                        <div class="ribbon ribbon-primary ribbon-shape">TẠO ĐƠN HÀNG THẺ THÁNG ZENLESS ZONE ZERO</div>
                    </div>
                    <form id="form">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="pack1">Hội Viên Inter-Knot(Thẻ Tháng) <span class="badge bg-info">95.000đ</span></label>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <input type="hidden" id="product_name" value="Hội Viên Inter-Knot(Thẻ Tháng)">
                    </form>
                </div>
            </div>
        </div>
